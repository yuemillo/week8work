<template>
  ...
  <div class="game-feature-bg bg-primary pb-5 mt90">
    <div class="container">
      <div class="row">
        <div class="col col-m-7 d-none d-xl-block">
        ...
        <div class="container-fluid bg-primary pb-3 d-xl-none">
          <div class="container d-flex flex-column align-items-center">
            <h3 class="display-1 fw-black text-black text-center pt-5 mb-3 text-nowrap">遊戲特色</h3>
            <div class="position-relative">
              <div class="fs-3 fw-black text-warning position-absolute text-shadow text-nowrap" style="bottom: 5px; right: 5px; ">可愛的貓咪英雄</div>
              <img src="/7a1ce4f6-c3f9-45d2-a3b7-94d83cd263da.jpg" alt="遊戲特色" class="img-fluid">
            </div>
          </div>
        </div>
        <div class="col col-m-5">
          ...
          <ul class="mt-3 fs-4">
            <li><p>遊戲類型：多人線上競技遊戲（MOBA）</p></li>
            <li><p>遊戲風格：可愛、卡通、英雄技能</p></li>
            <li><p>遊戲玩法：</p>
              <p class="fs-5">每個英雄都有獨特的技能和特點。</p>
              <p class="fs-5">團隊對戰，目標是摧毀對方的基地。</p>
              <p class="fs-5">地圖上有不同的路徑、野怪和塔。</p>
              <p class="fs-5">玩家可以升級技能、購買裝備，並與隊友合作。</p>
            </li>
            <li><p>遊戲特色：</p>
              <p class="fs-5">可愛的貓咪英雄，每個都有自己的故事和個性。</p>
              <p class="fs-5">美麗的遊戲場景，包括花園、森林、城堡等。</p>
              <p class="fs-5">豐富的技能和策略選擇。</p>
            </li>
          </ul>
        </div>
      </div>
