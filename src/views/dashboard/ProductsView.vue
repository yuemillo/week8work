<template>
  ...
  <div class="container">
    ...
    <PagintionComponent :pages="pages" :get-products="getProducts" />
  </div>
  <!-- Modal -->
  <ProductModalComponent :temp-product="tempProduct" :update-Product="updateProduct" :is-new="isNew" ref="controlModal" />
  <DelProductModalComponent :temp-product="tempProduct" :delete-Product="deleteProduct" ref="controlDelModal" />
</template>
